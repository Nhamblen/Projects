...
INSERT INTO `order_items` VALUES (1,1,2,1199.00,359.70,1),(2,2,4,489.99,186.20,1),(3,3,3,2517.00,1308.84,1),(4,3,6,415.00,161.85,1),(5,4,2,1199.00,359.70,2),(6,5,5,299.00,0.00,1),(7,6,5,299.00,0.00,1),(8,7,1,699.00,209.70,1),(9,7,7,799.99,240.00,1),(10,7,9,699.99,210.00,1),(11,8,10,799.99,120.00,1),(12,9,1,699.00,209.70,1),(13,10,6,415.00,161.85,1),(14,10,1,699.00,209.70,1),(15,11,6,415.00,161.85,1),(16,11,1,699.00,209.70,1),(25,12,6,415.00,161.85,1),(26,12,1,699.00,209.70,1),(27,13,6,415.00,161.85,1),(28,13,1,699.00,209.70,1),(29,14,6,415.00,161.85,1),(30,14,1,699.00,209.70,1),(31,15,6,415.00,161.85,1),(32,15,1,699.00,209.70,1),(33,16,6,415.00,161.85,1),(35,18,6,415.00,161.85,1),(36,18,1,699.00,209.70,1),(37,19,6,415.00,161.85,1),(38,19,1,699.00,209.70,1);
...
INSERT INTO `orders` VALUES (1,1,'2018-03-28 09:40:28',5.00,32.32,'2018-03-30 15:32:51',1,'Visa','4111111111111111','04/2020',2),(2,2,'2018-03-28 11:23:20',5.00,0.00,'2018-03-29 12:52:14',3,'Visa','4012888888881881','08/2019',3),(3,1,'2018-03-29 09:44:58',10.00,89.92,'2018-03-31 09:11:41',1,'Visa','4111111111111111','04/2017',2),(4,3,'2018-03-30 15:22:31',5.00,0.00,'2018-04-03 16:32:21',4,'American Express','378282246310005','04/2016',4),(5,4,'2018-03-31 05:43:11',5.00,0.00,'2018-04-02 14:21:12',5,'Visa','4111111111111111','04/2019',6),(6,5,'2018-03-31 18:37:22',5.00,0.00,NULL,7,'Discover','6011111111111117','04/2019',7),(7,6,'2018-04-01 23:11:12',15.00,0.00,'2018-04-03 10:21:35',8,'MasterCard','5555555555554444','04/2019',8),(8,7,'2018-04-02 11:26:38',5.00,0.00,NULL,9,'Visa','4012888888881881','04/2019',10),(9,4,'2018-04-03 12:22:31',5.00,0.00,NULL,5,'Visa','4111111111111111','04/2019',6),(10,3,'2022-10-30 13:23:39',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(11,3,'2022-10-30 13:23:54',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(12,3,'2022-10-30 13:27:54',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(13,3,'2022-10-30 13:27:55',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(14,3,'2022-10-30 13:27:57',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(15,3,'2022-10-30 13:27:59',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(16,3,'2022-10-30 19:11:56',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(18,3,'2022-10-30 19:14:46',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4),(19,3,'2022-10-30 19:14:52',10.00,0.00,NULL,4,'American Express','378282246310005','04/2016',4);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `products_after_update` BEFORE UPDATE ON `products` FOR EACH ROW BEGIN
...
CREATE TABLE `products_audit` (
  ...
  CONSTRAINT `products_audit_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`)
...
INSERT INTO `products_audit` VALUES (1,1,1,'strat','Fender Stratocaster',699.00,30.00,'2017-10-30 09:32:40'),(5,2,1,'les_paul','Gibson Les Paul',1199.00,30.00,'2017-12-05 16:33:13'),(6,3,1,'sg','Gibson SG',2517.00,50.00,'2018-02-04 11:04:31');
/*!40000 ALTER TABLE `products_audit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `products_auidt`
--

DROP TABLE IF EXISTS `products_auidt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `products_auidt` (
  `audit_id` int NOT NULL AUTO_INCREMENT,
  `product_id` int NOT NULL,
  `category_id` int NOT NULL,
  `product_code` varchar(10) NOT NULL,
  ...
  UNIQUE KEY `product_code` (`product_code`),
  KEY `category_id` (`category_id`),
  CONSTRAINT `products_auidt_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `products_auidt`
--

LOCK TABLES `products_auidt` WRITE;
/*!40000 ALTER TABLE `products_auidt` DISABLE KEYS */;
/*!40000 ALTER TABLE `products_auidt` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-12  0:23:00
